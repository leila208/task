        ...
        <div className="footer-main df">
          ...
          <div className="contacts ">
            <ul className="costumer-service">
              <li>
                Costumer Service <span id="footer-line"></span>
              </li>
              <li>
                <a href="">My Account</a>
              </li>
            ...
            <ul className="costumer-service">
              <li>Useful Links</li>
              <li>
                <NavLink end to="/haqqimizda">
                  Haqqimizda
                </NavLink>
              </li>
              <li>
                <NavLink end to="/elaqe">
                  Contact
                </NavLink>
              </li>
              <li>
            ...
            <ul className="reach-us">
              <li>Reach Us</li>
              <li className="location df">
                <i className="fa-solid fa-location-pin"></i>
                <p>
                  Jln Cempaka Wangi No 22 <br /> Jakarta - Indonesia
                </p>{" "}
              </li>
              <li className="phone df">
                <i className="fa-sharp fa-solid fa-phone"></i>
                <p>+6221 2002 2012</p>
              </li>
              <li className="mail df">
